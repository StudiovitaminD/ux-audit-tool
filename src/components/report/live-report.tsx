...
export function LiveReport({
        ...
        hydratedCompetitors.map(async (competitor) => {
          ...
          try {
            ...
            return {
              ...
              ...data,
              screenshot:
                asString(data.screenshot_url) || asString(data.screenshot) || asString(competitor.screenshot),
            };
          } catch {
            return competitor;
          }
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden px-6 pt-6 pb-40" data-report-live-root>
