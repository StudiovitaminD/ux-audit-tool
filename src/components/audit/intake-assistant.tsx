...
export function IntakeAssistant({
  ...
  const triggerButtonClass =
    "inline-flex items-center justify-center rounded-full border border-[#ff8a1f] bg-[#ff8a1f] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#f57f15] dark:border-[#ff8a1f] dark:bg-[#ff8a1f] dark:text-white dark:hover:bg-[#f57f15]";
        ...
        <Button
          ...
          className={
            placement === "fixed"
              ? triggerButtonClass
              : placement === "header"
                ? "inline-flex items-center justify-center rounded-full border border-[#ff8a1f] bg-[#ff8a1f] px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#f57f15] dark:border-[#ff8a1f] dark:bg-[#ff8a1f] dark:text-white dark:hover:bg-[#f57f15]"
              : "inline-flex w-full max-w-sm items-center justify-center rounded-full border border-[#ff8a1f] bg-[#ff8a1f] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#f57f15] dark:border-[#ff8a1f] dark:bg-[#ff8a1f] dark:text-white dark:hover:bg-[#f57f15] sm:w-auto"
          }
          ...
          <div className="absolute left-1/2 top-1/2 w-[min(920px,94vw)] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-3xl border border-white/10 bg-zinc-950/90 text-white shadow-2xl">
            ...
            <div className="space-y-4 p-5">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <label className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-[#ff8a1f] bg-[#ff8a1f] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#f57f15]">
                  <input
                    type="file"
