...
async function writeNarrative(args: {
  ...
  const plainLanguagePrompt = `${prompt}\n\nWriting requirement: Use very simple language for everyday users. Keep sentences short, explain jargon, and clearly state what is wrong, why it matters, and what to do next.`;
